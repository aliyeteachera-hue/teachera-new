...
import svgPaths from "./svg-rfw6o9fazt";
import imgHeroImage from "figma:asset/9f625b2269ea5e5eda8e881f7ee69f2278499d25.png";
import { imgFooterIconContainer } from "./svg-mhs3z";
...
function VuesaxLinearSend({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute contents inset-0">
...
type LanguageButtonTextProps = {
  text: string;
  additionalClassNames?: string;
};

function LanguageButtonText({ text, additionalClassNames = "" }: LanguageButtonTextProps) {
  return (
    <div className={clsx("absolute content-stretch flex items-center justify-center py-[6px] top-[110px]", additionalClassNames)}>
      <p className="font-['Neutraface_2_Text:Demi',sans-serif] leading-[32px] not-italic relative shrink-0 text-[16px] text-black">{text}</p>
    </div>
  );
}
...
export default function EgitimlerItalyanca() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_İtalyanca">
      <div className="absolute bg-[#e3e3e3] h-[95px] left-0 top-[80px] w-[1440px]" data-name="Menu Background" />
      ...
      <LanguageButtonText text="İNGİLİZCE" additionalClassNames="left-[150px]" />
      <LanguageButtonText text="İSPANYOLCA" additionalClassNames="left-[calc(16.67%+121px)]" />
      <LanguageButtonText text="FRANSIZCA" additionalClassNames="left-[calc(33.33%+112px)]" />
      <div className="absolute content-stretch flex items-center justify-center left-[calc(50%+92px)] py-[6px] top-[110px]" data-name="Language Button">
        <div aria-hidden="true" className="absolute border-b border-black border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[16px] text-black">İTALYANCA</p>
      </div>
      <LanguageButtonText text="ALMANCA" additionalClassNames="left-[calc(66.67%+70px)]" />
      <LanguageButtonText text="RUSÇA" additionalClassNames="left-[calc(83.33%+43px)]" />
      <div className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[16px] top-[521px] w-[449px] whitespace-pre-wrap">
        <p className="mb-0">Anadili İtalyanca olan eğitmenler ve optimize edilmiş ders planlarıyla, Teachera Teaching Method sayesinde yeni bir dili konuşmanın keyfini çıkarın.</p>
        <p className="mb-0">&nbsp;</p>
        <p>
          . Anadili İtalyanca olan eğitmenler
          <br aria-hidden="true" />. %100 İtalyanca eğitimler ile konuşma, okuma, yazma ve dinleme becerilerini geliştir
          <br aria-hidden="true" />. Özel Teachera Teaching Method ile öğrenmenin keyfini çıkar
          <br aria-hidden="true" />. Seviyene uygun ders planları ile hedeflerine ulaş
          <br aria-hidden="true" />. Birebir ve grup seçenekleri arasından kendine en uygun olanı seç
          <br aria-hidden="true" />. Konuşarak öğrenme fırsatı ile dil öğrenmenin en etkili yolunu keşfet
        </p>
      </div>
      <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[24px] left-[150px] not-italic text-[#09090f] text-[20px] top-[463px] w-[449px] whitespace-pre-wrap">Tüm seviyeler için İtalyanca dil becerilerinizi geliştiriyoruz.</p>
      <div className="absolute content-stretch flex gap-[10px] items-center left-[150px] top-[839px]" data-name="Button Container">
        ...
        <p className="font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#09090f] text-[14px]">Fiyatları Gör</p>
      </div>
      <p className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[32px] top-[353px] w-[341px] whitespace-pre-wrap">İTALYANCAYLA TANIŞ, DÜNYAYI KEŞFET</p>
      <div className="absolute contents left-0 top-[2044px]" data-name="Footer Container">
        <div className="absolute contents left-0 top-[2044px]" data-name="Footer Container">
          <div className="absolute h-[610px] left-0 top-[2044px] w-[1440px]">
          ...
          <div className="absolute h-0 left-[calc(8.33%+104px)] top-[2508.42px] w-[992px]">
          ...
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] left-[calc(75%-42px)] not-italic text-white top-[2433.42px]"
            data-name="KULE PLÂZA KAT: 26
Selçuklu – KONYA"
          >
            <p className="absolute leading-[0] left-[calc(75%-42px)] text-[0px] top-[2433.42px]">
              <span className="leading-[normal] text-[16px]">{`KULE PLÂZA KAT: `}</span>
              <span className="leading-[normal] text-[22px]">26</span>
            </p>
            <p className="absolute leading-[normal] left-[calc(75%-42px)] text-[16px] top-[2458.42px]">Selçuklu – KONYA</p>
          </div>
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(75%-42px)] not-italic text-white top-[2145.56px]"
            data-name="Sadece yazılı iletişim
WP: +905528674226"
          >
            <p className="absolute left-[calc(75%-42px)] text-[14px] top-[2145.56px]">Sadece yazılı iletişim</p>
            <p className="absolute left-[calc(75%-42px)] text-[20px] top-[2164.56px]">WP: +905528674226</p>
          </div>
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(75%-42px)] not-italic text-white top-[2221.56px]"
...
partners@teachera.com.tr"
          >
            <p className="absolute left-[calc(75%-42px)] text-[14px] top-[2221.56px]">Satış Departmanı</p>
            <p className="absolute left-[calc(75%-42px)] text-[20px] top-[2235.56px]">sales@teachera.com.tr</p>
            <p className="absolute left-[calc(75%-42px)] text-[14px] top-[2281.56px]">Medya Soruları İçin</p>
            <p className="absolute left-[calc(75%-42px)] text-[20px] top-[2295.56px]">media@teachera.com.tr</p>
            <p className="absolute left-[calc(75%-42px)] text-[14px] top-[2341.56px]">Ortaklıklar için</p>
            <p className="absolute left-[calc(75%-42px)] text-[20px] top-[2355.56px]">partners@teachera.com.tr</p>
          </div>
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(25%+86px)] not-italic text-[14px] top-[2106px]"
...
EĞİTİMLERİMİZ"
          >
            <p className="absolute left-[calc(25%+86px)] text-[#e05049] top-[2106px]">İŞ FIRSATLARI</p>
            <p className="absolute left-[calc(25%+86px)] text-[#e05049] top-[2156px]">MÜŞTERİ TEMSİLCİSİ OL</p>
            <p className="absolute left-[calc(25%+86px)] text-[#e05049] top-[2206px]">ELÇİ OL</p>
            <p className="absolute left-[calc(25%+86px)] text-white top-[2256px]">SIKÇA SORULAN SORULAR</p>
            <p className="absolute left-[calc(25%+86px)] text-white top-[2306px]">FİYATLAR</p>
            <p className="absolute left-[calc(25%+86px)] text-white top-[2356px]">EĞİTİMLERİMİZ</p>
          </div>
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(41.67%+100.5px)] not-italic text-[14px] text-white top-[2106px]"
...
Çağrı Merkezi Aydınlatma Metni M"
          >
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2106px]">KİŞİSEL VERİLERİN KORUNMASI</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2131px]">Gizlilik Politikası</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2156px]">Çocukların Gizlilik Politikası</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2181px]">Çerez Politikası</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2206px]">Ebeveyn Muvafakatname</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2231px]">Yurt Dışına Aktarım Açık Rıza</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2256px]">WhatsApp Açık Rıza Metni</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2281px]">Müşteri Aydınlatma Metni</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2306px]">İletişim Aydınlatma Metni</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2331px]">Çağrı Merkezi Aydınlatma Metni Müşteri</p>
            <p className="absolute left-[calc(41.67%+100.5px)] top-[2356px]">İlgili Kişi Başvuru Formu</p>
          </div>
          <div className="absolute h-[19.569px] left-[calc(8.33%+104px)] top-[2108px] w-[107.22px]" data-name="Footer Icon Container">
          ...
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(8.33%+104px)] not-italic text-[14px] text-white top-[2535.42px] whitespace-pre-wrap"
...
Milli Eğitim Bakanlığına bağlı faaliyet yürüten, online ve yüzyüze eğitim veren bir dil okuludur"
          >
            <p className="absolute left-[calc(8.33%+104px)] top-[2535.42px] w-[990.479px]">{`Teachera, Avrupa standartlarına karşılık gelen bir müfredat kullanarak, İngilizce, İspanyolca, Fransızca, Almanca, `}</p>
            <p className="absolute left-[calc(8.33%+104px)] top-[2550.42px] w-[389.497px]">İtalyanca, Rusça ve Arapça eğitimleri veren,</p>
            <p className="absolute left-[calc(8.33%+104px)] top-[2565.42px] w-[992px]">Milli Eğitim Bakanlığına bağlı faaliyet yürüten, online ve yüzyüze eğitim veren bir dil okuludur. C teachera ltd.şti</p>
          </div>
          <div
            className="absolute contents font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(8.33%+123.71px)] not-italic text-[26px] text-white top-[2187.83px]"
            data-name="09:00
21:30"
          >
            <p className="absolute left-[calc(8.33%+123.71px)] top-[2187.83px]">09:00</p>
            <p className="absolute left-[calc(8.33%+129.83px)] top-[2212.83px]">21:30</p>
          </div>
          <div className="absolute contents left-[calc(66.67%+44.02px)] top-[2102px]" data-name="Contact Info Container">
            <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(75%-44px)] not-italic text-[26px] text-white top-[2102px]">0332 236 80 66</p>
            <div className="absolute h-[21.956px] left-[calc(66.67%+44.02px)] top-[2112.04px] w-[21.958px]" data-name="phone_solid">
          ...
          <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[normal] left-[calc(8.33%+104px)] not-italic text-[#e05049] text-[14px] top-[2594px]">© Teachera 2024</p>
          <div className="absolute contents left-[calc(8.33%+104px)] top-[2461.93px]" data-name="Footer Icon Container">
            <div className="absolute contents left-[calc(8.33%+104px)] top-[2461.93px]" data-name="Clip path group">
              <div className="absolute h-[16.488px] left-[calc(8.33%+104px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[103.112px_16.488px] top-[2461.93px] w-[103.111px]" data-name="Footer Icon Container" style={{ maskImage: `url('${imgFooterIconContainer}')` }}>
      ...
      <div className="absolute h-[653px] left-[calc(41.67%+60px)] top-[259px] w-[780px]" data-name="Hero Image">
